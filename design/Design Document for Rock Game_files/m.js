...
return eval(rs);};})();
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/8c04f4c13e7d7452bcb345afbf0173ca 
// Or build this file again with packager using: packager build More/Fx.Accordion More/Slider
/*
---
copyrights:
  - [MooTools](http://mootools.net)
...
}});Class.Mutators.Binds=function(a){return a;};Class.Mutators.initialize=function(a){return function(){Array.from(this.Binds).each(function(b){var c=this[b];
